...
|----------|------|---------|--------------|
| Writing Rules | `.claude/rules/writing-rules.md` | 25 rules | Mar 13, 2026 |
...
|-----------|------|--------|-------|
| Vaelen | `characters/vaelen.md` | Active | Senior practitioner, pattern reader. POV 60%. |
| Drenna | `characters/drenna.md` | Active | Rotation practitioner. POV 30%. |
| Caeleth | `characters/caeleth.md` | Active | Junior practitioner. Dies Ep5. Build to be loved. |
| Sorvyn | `characters/sorvyn.md` | Active | Veteran practitioner. Arc: idealized trust → resentment → mutual betrayal. |
| Jorath | `characters/jorath.md` | Active | Logistics/equipment/resourceful problem-solver. |
| Zethael | `characters/zethael.md` | Active | Eduardo parallel. Two innovations (method + tech). First POV in Ep3. |
| Alythra | `characters/alythra.md` | Active | |
...
|----------|------|--------|-------|
| Story DNA v1 | `reference/story-dna-v1.md` | **Active** | 24 locked topics. THE most important reference doc. |
| GRRM Fix Plan | `reference/grrm-fix-plan.docx` | **Active** | POV distribution (60/30/10), structural corrections. |
| Creatures as Infrastructure | `reference/creatures-as-infrastructure.md` | **Active** | Creature system details. |
| Vaelen Reframe | `reference/vaelen-reframe-gifts.md` | **Active** | Gift-first characterization, five gifts. |
| Drenna Complete Arc | `reference/drenna-complete-arc.md` | **Active** | Full 3-season Drenna arc. |
| Audit Report | `reference/audit-report.md` | **Active** | Full reconciliation of all old docs. |
| Source: Tabata Amaral | `reference/source-tabata-amaral.md` | **Active** | Character DNA for Drenna. |
| Source: Eduardo/Real Valor | `reference/source-eduardo-realvalor.md` | **Active** | Character DNA for Zethael. |
...
- **Doumm eliminated** — His roles (creature-bond specialist, the heart, Mirathyn joke, Ep4 death) redistributed to Caeleth and others.
- **Zethael in Episode 1** — Appears in wayhouse/table scene (Drenna/Zethael/Vaelen). First POV in Episode 3.
- **Vardo → Zethael** — Old working name retired. All canonical docs use Zethael.
- **POV distribution** — Vaelen 60%, Drenna 30%, Zethael 10% (per GRRM Fix Plan).
- **Episode count** — 9 episodes (was 8; old Ep2 split into Ep2+Ep3). Not 10 from World Bible v10.
- **Zethael two innovations** — METHOD (rapid iteration) + TECH (mechanical communication — physical, NOT Amarvel-based). Separate categories, same curiosity origin.
- **Mirathyn terminology** — "Mirathyn" = wine form. "X" = extract. NEVER "light" or "concentrated."
- **Zethael appearance** — Short hair (self-cut). NOT long/pushed back. Attractive, nice build.
- **Zethael Mirathyn** — Full abstention. Does NOT drink. Previous "drinks socially" is WRONG.
- **Solvarei HQ** — Workplace, not residence. Nobody lives there. Practitioners have homes in Darachet.
- **Solvarei/Amarith** — Independent organizations. Neither reports to the other. Different scope (trunk vs branch).
- **No filing culture** — No reports, appendices, forms. Information through conversation and debrief.
- **Writing Rule 24** — Simile restraint. One simile per scene max.
...
- **Korvathi eat creatures** — Taboo in Sorathel (creatures are bonded, not food). Korvathi creatures aren't bonded — no network. Range of attitudes: admiration (Maarthen), excitement (entrepreneur), contempt (Lucro), unease (Devriis).
- **Korvaan's entrance exchange** — Does NOT volunteer personal origin. "You hated the Mirathyn. Nobody at that table noticed. That's your answer." Bene Gesserit perception through observation, not disclosure.
- **Maarthen NOT diminished by Korvaan** — Plays it light/joking. Different species of power, not hierarchy.
- **Writing Rule 26** — No Lazy Repetition. Never reuse distinctive phrases in the same chapter.
- **Jorath vehicle project** — Building a transport vehicle part by part (Ford Mustang restoration energy). First POV chapter: Ep2 Ch2.
- **Ep2 Ch2 = Jorath POV** — Caeleth beloved-building through witnesses (Vaelen Ch1, Jorath Ch2, Vaelen Ch4). No Caeleth POV in Ep2.
...
- **Misattribution:** After Ep5, institutions call Dread "dead-zone weapon." Prevents investigation. Season 2: more zones appear.
- **Jorath = NOT money-comedy.** Physical competence and resourcefulness. "Engagement" running joke. In Dread: "Kid. KID." — voice cracking.
- **Drenna's transition:** Present Ep1-2, diverges at Velanthra (upper city). Vaelen's jealousy subtle (Sorvyn notices).
- **Season 1 ends with "victory"** — hollow. Outer cultures contained. Dread classified/contained. Reader knows it's not over.
